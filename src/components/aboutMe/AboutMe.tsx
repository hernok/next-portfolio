  ...
  return (
    <div>
      ...
      <p className="text-gray-800 text-sm py-2 md:text-xl dark:text-gray-200">
        ...
        utviklerverdenen byr på. Selv om jeg støtte på utfordringer, som en lav
        karakter i JavaScript, har jeg opparbeidet meg erfaringer som har gjort
        meg mer bestemt og dyktig. Jeg har også erfaring med SQLite3 samt
        Node.js, CMS og nettstedsdeployment, demonstrert ved prosjektet{" "}
        <Link
      ...
      <p className="text-gray-800 text-sm  py-2 md:text-xl dark:text-gray-200">
        Jeg er på utkikk etter en rolle som frontend- eller webutvikler, som har
        et godt arbeidsmiljø hvor samarbeid og kunnskapsdeling står i fokus. Jeg
