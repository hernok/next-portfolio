	...
	return (
		<div className="mt-20 lg:flex gap-10 ">
			<div className="flex-1 text-center shadow-lg p-10 rounded-xl">
				...
				<h4 className="py-4 text-teal-600">Språk, rammeverk og bibliotek</h4>
			...
			<div className="flex-1 text-center shadow-lg p-10 rounded-xl">
				...
				<h4 className="py-4 text-teal-600">Design verkrøy jeg bruker</h4>
			...
			<div className="flex-1 text-center shadow-lg p-10 rounded-xl">
				...
				<h4 className="py-4 text-teal-600">Andre verktøy</h4>
